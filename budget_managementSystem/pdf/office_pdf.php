...
$activity = "Generate Report in Department/Office Records";
...
$pdf->SetAuthor('bms');
$pdf->SetTitle('Department/Office Records Report');
$pdf->SetSubject('TCPDF Report');
$pdf->SetKeywords('TCPDF, PDF, report, Department/Office Records');
...
$pdf->Cell(0, 15, 'Department/Office Records Report', 0, 1, 'C');
...
$pdf->Output('department_logs_report.pdf', 'D');
